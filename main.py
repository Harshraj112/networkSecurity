...
from cybersentinel.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig
from cybersentinel.entity.config_entity import TrainingPipelineConfig
